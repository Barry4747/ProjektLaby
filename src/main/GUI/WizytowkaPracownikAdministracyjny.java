...
public class WizytowkaPracownikAdministracyjny extends JPanel {
    private PracownikAdministracyjny pracownik;

    public WizytowkaPracownikAdministracyjny(PracownikAdministracyjny pracownik){
        ...
        JLabel liczbaNadgodzin = new JLabel("Liczba nadgodzin: "+pracownik.getLiczbaNadgodzin());
        liczbaNadgodzin.setBounds(500, 200, 300, 30);
        liczbaNadgodzin.setFont(new Font("Arial", Font.PLAIN, 16));
